...
import { DollarSign, ShoppingBag, CreditCard, Truck, Edit, CheckSquare, Square } from 'lucide-react'
...
export default async function DealerDashboardContent() {
  ...
  const [profileRes, ordersRes] = await Promise.all([
    ...
    supabase.from('orders').select('*, species:species_id(name)').eq('dealer_id', user.id).order('created_at', { ascending: false })
  ])
